...
extern "C"
{
      ...
      VVASFrame * input[MAX_NUM_OBJECT], VVASFrame * output[MAX_NUM_OBJECT])
  {
    ...
    Mat lumaImg(input[0]->props.height / 2, input[0]->props.width / 2, CV_8UC1, (char *)inframe->vaddr[0]);
    Mat chromaImg(input[0]->props.height / 4, input[0]->props.width / 4, CV_16UC1, (char *)inframe->vaddr[1]);
    Mat tcpimage;
